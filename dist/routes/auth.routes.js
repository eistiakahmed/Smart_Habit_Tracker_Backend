...
router.post('/register', rateLimit_middleware_1.authLimiter, (0, upload_middleware_1.singleUpload)('avatar'), auth_controller_1.default.register);
...
router.put('/profile', auth_middleware_1.authenticate, (0, upload_middleware_1.singleUpload)('avatar'), auth_controller_1.default.updateProfile);
