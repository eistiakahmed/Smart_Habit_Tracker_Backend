...
export interface QuickNoteResponse {
  ...
  checklistProgress?: number; // Virtual field
  createdAt: Date;
  updatedAt: Date;
}
...
export interface QuickNoteFilter {
  category?: NoteCategory;
  priority?: NotePriority;
  status?: NoteStatus;
  isArchived?: boolean;
  ...
  tags?: string[];
  search?: string;
  sortBy?: 'priority' | 'reminder' | 'due' | 'title' | 'created' | 'updated' | 'checklist';
  reminderDue?: 'today' | 'upcoming' | 'overdue';
